        ...
        <section id='call-action' className='md:container mx-auto p-[60px_0]'>
            <div className="p-[4rem_2rem] relative rounded-xl bg-accent/90 w-full">
                <div className=' flex flex-col flex-wrap mt-[calc(-1_*_0)] mr-[calc(-.5_*_1.5rem)] ml-[calc(-.5_*1.5rem)]'>
                    ...
                    <div className="w-[250px] h-[250px] absolute top-[-20px] right-[-20px] opacity-[.1] transform-[rotate(45deg)] animate-shaps-float">
                        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M47.1,-57.1C59.9,-45.6,68.5,-28.9,71.4,-10.9C74.2,7.1,71.3,26.3,61.5,41.1C51.7,55.9,35,66.2,16.9,69.2C-1.3,72.2,-21,67.8,-36.9,57.9C-52.8,48,-64.9,32.6,-69.1,15.1C-73.3,-2.4,-69.5,-22,-59.4,-37.1C-49.3,-52.2,-32.8,-62.9,-15.7,-64.9C1.5,-67,34.3,-68.5,47.1,-57.1Z" transform="translate(100 100)"></path>
                        </svg>
                    </div>
                    <div className="w-[200px] h-[200px] bottom-[-30px] left-[50px] opacity-[.15] transform-[rotate(15deg)] animate-shaps-float absolute">
                        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M41.3,-49.1C54.4,-39.3,66.6,-27.2,71.1,-12.1C75.6,3,72.4,20.9,63.3,34.4C54.2,47.9,39.2,56.9,23.2,62.3C7.1,67.7,-10,69.4,-24.8,64.1C-39.7,58.8,-52.3,46.5,-60.1,31.5C-67.9,16.4,-70.9,-1.4,-66.3,-16.6C-61.8,-31.8,-49.7,-44.3,-36.3,-54C-22.9,-63.7,-8.2,-70.6,3.6,-75.1C15.4,-79.6,28.2,-58.9,41.3,-49.1Z" transform="translate(100 100)"></path>
                        </svg>
                    </div>
                    <div className="w-[200px] h-[200px] top-[50px] left-[10%] opacity-[.1] transform-[rotate(15deg)] animate-shaps-float absolute">
                    ...
                    <div className="absolute w-[150px] h-[150px] bottom-[20px] right-[15%] opacity-[.15] transform-[rotate(-10deg)] animate-shaps-float">
                        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-[150px] h-[150px] top-[20%] right-[15%] opacity-[.08] transform-[rotate(15deg)] absolute">
                        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
